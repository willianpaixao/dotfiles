...
#    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
    export PS1='\[$(tput setaf 125)\]\u\[$(tput setaf 136)\]@\[$(tput setaf 125)\]\h\[$(tput setaf 136)\]:\[$(tput setaf 125)\]\W\[$(tput setaf 136)\]$(__git_ps1 " (%s)") \$ \[$(tput sgr0)\]'
else
...
if [ -f '/home/willian/opt/google-cloud-sdk/completion.bash.inc' ]; then . '/home/willian/opt/google-cloud-sdk/completion.bash.inc'; fi
